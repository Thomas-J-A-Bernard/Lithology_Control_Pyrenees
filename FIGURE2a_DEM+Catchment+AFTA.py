...
ExportFigure = Export_Directory+'FIGURE1a_Pyrenees_DEM+Catchment+AFTA.pdf'
...
csv_file1 = Import_Directory+'AFT_Data_used.csv'
csv_file2 = Import_Directory+'AFT_Data_not_used.csv'
...
MF.add_point_data(thisPointData=thisPointData1,
                  ...
                  colorbarlabel='Apatite fission track age',
...
#%%====================================TEST=================================%%#
boxc1=TextArea(' AFTA available:\n AFTA used for the study:',textprops=dict(color='k',fontsize=9))
